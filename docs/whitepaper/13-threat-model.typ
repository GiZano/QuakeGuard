...
#table(
  ...
  [Tampering], [MITM alters event magnitude], [Payload hash (SHA-256) checked against signature], [§4.4],
  [Repudiation], [Node denies sending a false alert], [Public key strictly bound to Sensor ID at provisioning], [§4.3],
  ...
  [Elevation of Priv], [Node attempts to provision others], [Enrollment Token required for `/devices/register`], [§4.3]
)
